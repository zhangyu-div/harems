<template>
    <div id="echarts">
      ...
      <div id="myChartfive" :style="{width: '1500px', height: '400px'}"></div>
    </div>
</template>
<script>
export default {
  ...
  methods:{
    drawLine() {
      ...
      let myChartfour = this.$echarts.init(
        document.getElementById("myChartfour")
      );
      let myChartfive = this.$echarts.init(
        ...
        series: [
          {
            ...
            center: ["50%", "50%"],
            data: [
              { value: 335, name: "1917宫" },
              { value: 310, name: "1918宫" },
              { value: 274, name: "1912宫" },
              { value: 235, name: "如意楼" },
              { value: 400, name: "冷宫" }
            ].sort(function(a, b) {
